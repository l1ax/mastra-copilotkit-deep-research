...
class GenerateQueriesPrompt {
    format(researchTopic: string, currentDate: string, queryCount: number): OpenAI.Chat.Completions.ChatCompletionMessageParam[] {
        const prompt = `
...
- Don't produce more than ${queryCount} queries.
...
export const generateQueriesPrompt = new GenerateQueriesPrompt();